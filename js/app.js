    ...
    constructor(){
       ...
       for(let i =0 ; i < data.length ;i++){
          if(data[i].position == 'left'){
            this.card.push(new Card(this.itemBar[0],data[i].subTitle,data[i].contents,data[i].src));
          }else if(data[i].position == 'right'){
            this.card.push(new Card(this.itemBar[1],data[i].subTitle,data[i].contents,data[i].src));
          }
       }
